...
\fancyhead[L]{NTOU \_\_ZZZZZZZZZ\_\_}
\fancyhead[R]{\thepage}
...
\section{資料結構}
    \subsection{線段樹}
    \lstinputlisting{data/segmenttree.cpp}

    \subsection{Fenwicktree}
    \lstinputlisting{data/Fenwicktree.cpp}
...
\section{計算幾何}
    ...
    \subsection{最小圓包覆-隨機增量}
    \lstinputlisting{geometry/MECrandom.cpp}

    \subsection{最小圓包覆-三分搜尋}
